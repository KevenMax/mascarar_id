...
class PessoasControllerTest < ActionController::TestCase
  ...
  test "should create pessoa" do
    assert_difference('Pessoa.count') do
      post :create, pessoa: { data_nascimento: @pessoa.data_nascimento, idade: @pessoa.idade, nome: @pessoa.nome, slug: @pessoa.slug }
    end
  ...
  test "should update pessoa" do
    patch :update, id: @pessoa, pessoa: { data_nascimento: @pessoa.data_nascimento, idade: @pessoa.idade, nome: @pessoa.nome, slug: @pessoa.slug }
    assert_redirected_to pessoa_path(assigns(:pessoa))
  end
